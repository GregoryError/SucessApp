...
//=====================================================
  ...
  /////////////////////////////////////////////////////////////////////////////////////////  PAY_BUTTONS
             ...
             Button{
                ...
                onClicked:{
                    visible: false
                    atmTextBlock.visible = false
                    paypoints_anim_up.running = true
                    paypoints_txt.text = "Ближайшие точки оплаты"


                    // additional clean up


                    closeback_access.visible = false
             ...
             Button{
                 ...
                 NumberAnimation{
                     ...
                     from: paylist.y + paylist.height
                     //to: paylist.y + paylist.height + atmTextBlock.height + 500
                     to: paylist.y + paylist.height + 1100
                 ...
                 NumberAnimation{
                     id: paypoints_anim_up
                     target: paypoints

                     from: paylist.y + paylist.height + 1100
                     to: paylist.y + paylist.height
                ...
                onClicked:{
                  ...
                  paypoints_txt.text = "Обновить координаты GPS"
                  paypoints_anim.running = true
                  closeback.visible = true
                  closebacksappear.running = true


                     atmTextBlock.text = "<b>Ближайшие точки оплаты:</b><br><br>"
                    + BackEnd.showATM() +
                     "<br> <br> Для более точного определения <br>
                      местоположения, рекомендуется <br>
                      включить GPS модуль в настройках <br>
                      вашего устройства."
                      atmTextBlock.visible = true
                    closeback_access.toggle()
